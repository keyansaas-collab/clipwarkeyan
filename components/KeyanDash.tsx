    ...
    <div className="kd-root">
      ...
      <div className="kd-wrap">
        <header className="kd-head">
          ...
          <p className="kd-sub">{loading ? "chargement…" : `${setters.length} setters · ${kpis.vendus} ventes cette période`}</p>
        </header>
